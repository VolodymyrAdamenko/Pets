...
/**
 * in this case one class know about another class, which provoke strong coupling. 
 * For instance, if we wont to change power producer, we should change a lot in the class. 
 * On other hand, we may create interim interface, and inherited in separate classes  
 */
class PowerStation{
...
class DieselGenerator implements PowerPlant{
	...
	public void energyGeneration(){
		System.out.println("I am generating CO2 emission energy");
	}}
